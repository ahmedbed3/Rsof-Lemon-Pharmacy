...
using lemonPharmacy.Common.Infrastructure.AspNetCore.Authz;

namespace lemonPharmacy.Common.Infrastructure.AspNetCore.Configuration
{
    public static class ConfigurationExtensions
    {
        public static string GetHostUri(this IConfiguration config, IWebHostEnvironment env, string groupName)
        {
        ...
        public static AuthNOptions GetAuthNOptions(this IConfiguration config,string feature)
        {
            var options = new AuthNOptions();
            config.GetSection($"Features:{feature}").Bind(options);
            return options;
        }
        public static string GetAuthUri(this IConfiguration config, IWebHostEnvironment env)
        {
