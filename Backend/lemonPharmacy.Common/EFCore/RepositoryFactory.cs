...
namespace lemonPharmacy.Common.Infrastructure.EfCore
{
    ...
    public class QueryRepository<TDbContext, TEntity> : QueryRepositoryWithId<TDbContext, TEntity, int>, IQueryRepository<TEntity>
        ...
        where TEntity : class, IAggregateRoot
    {
        ...
        public Task<List<TResponse>> ExecuteProcedureAsync<TResponse>(string query, object parms)
        {
